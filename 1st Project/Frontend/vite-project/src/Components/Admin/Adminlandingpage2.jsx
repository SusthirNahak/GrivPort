    ...
    return (
        <div className="md:flex h-[100vh] w-full bg-amber-100 overflow-hidden" >
            ...
            <div className="w-full h-[60%] flex flex-col md:justify-center items-center md:w-[65%] md:h-full">
                ...
                <h2 className="text-5xl text-orange-700 font-semibold pt-0 pb-2 md:py-2 md:text-6xl">
                    Welcome to
                </h2>
            ...
            <div className="w-full h-[40%] px-10 md:w-[35%] md:h-full md:bg-[#f8f8f8] md:flex md:justify-center md:items-center">
                {/* Sign In Form */}
                ...
                <form onSubmit={handleSubmit}>
                    ...
                    {(step === 1 || window.innerWidth >= 768) && (
                        <div className="mb-4">
                            <label htmlFor="email" className="block text-lg font-medium text-black pb-3">
                                Email<sup className="text-red-500 text-lg">*</sup>
                            </label>
                            <div className="relative">
                                <span className="absolute top-1/2 transform -translate-y-1/2 text-black text-lg border-r-1 px-2">
                                    <img width="24" height="24" src="https://img.icons8.com/sf-regular-filled/48/new-post.png" alt="new-post" />
                                </span>
                                <input
                                    type="email"
                                    id="email"
                    ...
                    {(step === 2 || window.innerWidth >= 768) && (
                        <div className="mb-4">
                            <label htmlFor="password" className="block text-lg font-medium text-black pb-3">
                                Password<sup className="text-red-500 text-lg">*</sup>
                            </label>
                            <div className="relative">
                                <span className="absolute top-1/2 transform -translate-y-1/2 text-black text-lg border-r-1 px-2">
                                    <img width="24" height="24" src="https://img.icons8.com/sf-regular-filled/48/password.png" alt="password" />
                                </span>
                                <input
                                    type="password"
                                    id="password"
                            ...
                            step === 1 ? (
                                <button
                                    ...
                                    onClick={  () => {
                                        ...
                                        // You can also add a basic email format check if needed:
                                    ...
                                    className={`w-full py-3 bg-green-500 text-white font-semibold rounded-md hover:bg-green-600 transition duration-200 cursor-pointer ${!email ? "opacity-50 cursor-not-allowed" : ""}`}
                                ...
                                <input
                                    type="submit"
                                    disabled={isSubmitting}
                                    className={`w-full py-3 bg-green-500 text-white font-semibold rounded-md hover:bg-green-600 transition duration-200 cursor-pointer ${isSubmitting ? "opacity-50 cursor-not-allowed" : ""}`}
                                    value={isSubmitting ? "Submitting..." : "Sign In"}
